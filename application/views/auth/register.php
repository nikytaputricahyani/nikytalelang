                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
						<div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Registrasi Pages Auth!</h1>
                                </div>
                                ...
                                <form class="user" method="post" action="">
									...
									<div class="form-group">
										<input type="text" name="fullname" id="fullname" class="form-control form-control-user form-control-user" 
										value="<?php echo set_value('fullname');?>" placeholder="fullname">
									<?php echo form_error('fullname') ?>
										</div>
								...
								<div class="form-group col-sm-6">
										<input type="password" name="repassword" id="repassword" class="form-control form-control-user" 
