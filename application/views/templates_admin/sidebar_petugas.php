    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">LELANG NIKYTA </div>
            </a>
            ...
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('petugas/Data_barang'); ?>">
                    <i class="fas fa-fw fa-gift"></i>Data Barang
                </a>
            </li>
            <hr class="sidebar-divider my-0">
            ...
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('petugas/Data_lelang'); ?>">
                    <i class="fas fa-fw fa-layer-group"></i>Data Lelang
                </a>
            </li>
            ...
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('petugas/laporan/laporan_lelang'); ?>">
                    <i class="fas fa-fw fa-address-book"></i>Laporan Data Lelang Dibuka 
                </a>
            </li>
            ...
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('petugas/laporan'); ?>">
                    <i class="fas fa-fw fa-address-book"></i>Laporan Data Lelang Ditutup
                </a>
            </li>
            ...
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('petugas/laporan_barang'); ?>">
                    <i class="fas fa-fw fa-address-book"></i>Laporan Barang
                </a>
            </li>
