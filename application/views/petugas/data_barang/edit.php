    ...
    <div class="container-fluid">
        ...
        <div class="card border-dark">
			...
			<input type="hidden" readonly value="<?= $tb_barang['id_barang']; ?>" class="form-control" name="id_barang" id="id_barang">
				...
				<div class="form-group">
					<label for="price">Harga barang</label>
					<input type="text" name="harga_awal" id="harga_awal" value="<?= $tb_barang['harga_awal'] ?>" 
					class="form-control" placeholder="Enter the product price" />
				</div>
				...
				<div class="form-group">
								...
								width="100">
								<input type="file" name="gambar" id="gambar" class="form_control" value="<?=
